...
Floor3::Floor3( float height, float width, int rows, int columns)
...
void Floor3::setOrientation(vec3 pOrientation) {
	orientation = pOrientation;
	applyOrientation();
}

void Floor3::applyOrientation() {
	if (orientation.x == 1) {
